...
if (!class_exists('CPT_Class')) {
    class CPT_Class {
        ...
        function __construct() {
            ...
            //add_action( 'init', array( $this, 'ap_cpt_fontawesome_icons' ) );
        }
         ...
         */
         function meta_boxes() {
            ...
            include('inc/backend/metaboxes/price-metabox.php');
         }
