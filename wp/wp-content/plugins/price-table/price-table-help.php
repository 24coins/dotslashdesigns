    ...
    if(price_table_customer_type=="free")
        {
            ...
            echo 'You are using <strong> '.price_table_customer_type.' version  '.price_table_plugin_version.'</strong> of <strong>'.price_table_plugin_name.'</strong>, To get more feature you could try our premium version. ';
