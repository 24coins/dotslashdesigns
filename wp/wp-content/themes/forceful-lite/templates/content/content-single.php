...
?>
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <?php if ( 'show' == $forceful_lite_options_featured_image_status && 'small' == $forceful_lite_options_post_thumbnail_style && has_post_thumbnail() ) { ?>
        ...
        <header>
            ...
            <div class="entry-box-title clearfix">
                ...
                <div class="meta-box">
                    ...
                    if ( 'show' == get_theme_mod('forceful_lite_options_post_view_count_status' , 'show') && $forceful_lite_total_view ) {
                    ?>
        ...
        <?php if ( 'show' == $forceful_lite_options_featured_image_status && 'large' == $forceful_lite_options_post_thumbnail_style ) { ?>
            <div class="entry-thumb">
