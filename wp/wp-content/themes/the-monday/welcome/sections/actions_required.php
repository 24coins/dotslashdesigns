<?php
	...
	if($show_success_notice) :
		...
		<div class="action-tab success">
			<h3><?php printf( 'All Recommended action has been successfully completed.', 'the-monday'); ?></h3>
			<a class="button button-primary" href="<?php echo esc_url(admin_url('customize.php')); ?>"><?php echo esc_html__('Customize Theme', 'the-monday'); ?></a>
		</div>
		<?php
	else :
			...
			if($plugin['bundled'] == false) {
				...
				if(!isset($info->errors)) :
					...
					<div class="action-tab warning">
						<h3><?php printf( esc_html__("Install : %s Plugin", 'the-monday'), $info->name ); ?></h3>
						<p><?php esc_html_e('Install Contact Form 7 to add the contact forms.', 'the-monday'); ?></p>
				...
				?>
				<div class="action-tab warning">
					<h3><?php printf( esc_html__("Install : %s Plugin", 'the-monday'), $plugin['name'] ); ?></h3>
					<p><?php esc_html_e('Instant Demo Importer Plugin adds the feature to Import the Demo Conent with a single click.', 'the-monday'); ?></p>
