		...
		class Accesspress_Basic_Welcome {
			...
			public function __construct() {
				...
				$this->tab_sections = array(
					...
					'import_demo' => __('Import Demo', 'the-monday'),
				...
				$this->free_plugins = array(
					...
					'accesspress-custom-post-type' => array(
						...
						'filename' => 'accesspress-custom-post-type.php',
						'class' => 'CPT_Class'
					),
				);
			...
			public function themonday_activation_admin_notice() {
				...
				if( is_admin() && ('themes.php' == $pagenow) && (isset($_GET['activated'])) ) {
					...
					<div class="notice notice-success is-dismissible">
						<p><?php printf( __( 'Welcome! Thank you for choosing %1$s! Please make sure you visit our <a href="%2$s">Welcome page</a> to get started with %1$s.', 'the-monday' ), $this->theme_name, admin_url( 'themes.php?page=themonday-welcome' )  ); ?></p>
						<p><a class="button" href="<?php echo admin_url( 'themes.php?page=themonday-welcome' ) ?>"><?php _e( 'Lets Get Started', 'the-monday' ); ?></a></p>
					</div>
					<?php
				}
			}
			...
			public function themonday_welcome_screen() {
				...
				<div class="wrap about-wrap access-wrap">
					<h1><?php printf( esc_html__( 'Welcome to %s - Version %s', 'the-monday' ), $this->theme_name, $this->theme_version ); ?></h1>
					<div class="about-text"><?php printf( esc_html__( 'The %s is an elegant responsive WordPress theme for any type of business or freelancers. It is feature-rich, multi-purpose and powerful WordPress theme with a beautiful and user-friendly design. It offers a complete customization capability and multiple options for building a website instantly.', 'the-monday' ), $this->theme_name ); ?></div>
				...
				<div class="nav-tab-wrapper clearfix">
					<?php foreach($tabs as $id => $label) : ?>
						...
						?>
						<a href="<?php echo admin_url('themes.php?page=themonday-welcome&section='.$id); ?>" class="<?php echo $nav_class; ?>" >
			...
			public function themonday_plugin_installer_callback(){
				...
				if ( ! current_user_can('install_plugins') )
					wp_die( __( 'Sorry, you are not allowed to install plugins on this site.', 'the-monday' ) );
				...
				if (! wp_verify_nonce( $nonce, 'themonday_plugin_installer_nonce' ))
					wp_die( __( 'Error - unable to verify nonce, please try again.', 'the-monday') );
			...
			public function themonday_plugin_activation_callback(){
				...
				if ( ! current_user_can('install_plugins') )
					wp_die( __( 'Sorry, you are not allowed to activate plugins on this site.', 'the-monday' ) );
				...
				if (! wp_verify_nonce( $nonce, 'themonday_plugin_activate_nonce' ))
					die( __( 'Error - unable to verify nonce, please try again.', 'the-monday' ) );
