...
/*-------------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    $settings_priority = 5 ;
    $seperator_label = array( __( "", "the-monday" ), __( "First skill", "the-monday" ), __( "Second skill", "the-monday" ),  __( "Third skill", "the-monday" ), __( "Fourth skill", "the-monday" ) );
    $default_skill_title = array( __( "", "the-monday" ), __( "Web Design", "the-monday" ), __( "Html/Css", "the-monday" ), __( "Graphic Design", "the-monday" ), __( "UI / UX", "the-monday" ) );
    $default_skill_percentage = array( __( "", "the-monday" ), __( "90", "the-monday" ), __( "75", "the-monday" ), __( "70", "the-monday" ), __( "85", "the-monday" ) );
    for( $i=1; $i<=4; $i++ ) {
