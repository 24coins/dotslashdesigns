...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
  ...
  <a class="navbar-brand" href="#"><img alt="Balloon Thumbnail" class="img-fluid img-thumbnail" src="assets/images/balloon.png" width="50"></a>
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#">./Dotslash Designs LLC<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
====================================================================================== -->
	<div class="panel">
		<div class="container-fluid">
			<div class="jumbotron">
				<img alt="Where will Dotslash Designs LLC take you...?" class="d-block img-responsive" src="assets/images/balloon.png">
				<div col="col-"
				<h1>Dream big.</h1>
	...
	<div class="panel">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-4 col-md-4 col-lg-4">
					<img alt="Dotslash Designs LLC will help you enjoy the details as well as the big picture." class="d-block img-fluid img-responsive" src="assets/images/hummingbird.png">
				</div>
			</div>
		</div>
	</div>
	<div class="panel">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-4 col-md-4 col-lg-4">
					<img alt="Dotslash Designs LLC provides a full spectrum tunnel, not just a light at the end." class="d-block img-fluid img-responsive" src="assets/images/straws.png">
				</div>
				<div class="col-sm-4 col-md-4 col-lg-4">
	...
	<div class="panel">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-4 col-md-4 col-lg-4">
					<img alt="Dotslash Designs LLC will help you spread your wings." class="d-block img-fluid img-responsive" src="assets/images/peacock.png">
				</div>
			</div>
		</div>
	</div>
