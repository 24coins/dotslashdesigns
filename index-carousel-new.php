...
<body>
	<nav class="navbar navbar-toggleable-xs navbar-toggleable-sm navbar-toggleable-md navbar-toggleable-lg navbar-light bg-faded">
	  	<div class="container">
	  		<a class="navbar-brand hidden-sm-down" href="#"><img alt="Dotslash Designs Logo Thumbnail" class="img-fluid img-thumbnail" src="assets/images/dsd_logo_thumbnail.png" width="50"></a>	
			<button class="navbar-toggler navbar-toggler-center hidden-md-up" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-label="Toggle navigation">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
						<img alt="Where will Dotslash Designs LLC take you...?" class="first-slide d-block img-item img-fluid img-responsive" src="assets/images/balloon.png">
				...
				<div class="item">
					<img alt="With Dotslash Designs LLC, you set your own pace." class="third-slide d-block img-fluid img-responsive" src="assets/images/track.png">
					<div class="carousel-caption">
						<h1>Set your pace.</h1>
						<p>You know where you started from. You know where you want to end up. You set your pace.<strong> Dotslash Designs LLC </strong>will provide you all the help you need along the way.</p>
					</div>
				</div>
				<div class="item">
