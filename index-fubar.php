...
====================================================================================== -->
	<div class="container">
		<div class="row">
			<img alt="Where will Dotslash Designs LLC take you...?" class="first-slide d-block img-item img-responsive" src="assets/images/balloon.png">
			<div class="col-sm-4 col-md-r col-lg-4">
				<h1>Dream big.</h1>
	...
	<div class="container">
		<div class="row">
			<img alt="Dotslash Designs LLC provides a full spectrum tunnel, not just a light at the end." class="third-slide d-block img-item img-fluid img-responsive" src="assets/images/straws.png">
			<div class="col-sm-4 col-md-r col-lg-4">
